...
A Dark Room has been a #1 app. The Ensign has made it into the
top #10 list. A Noble Circle has been the #1 Music game and #3 RPG.
...
while watching TV, waiting in lines, etc. So you want your games to be
...
and Sword of Xolan. The controls are tight and satisfying.

You may also want to consider games that are played in portrait mode,
one handed. It's one of the reasons why Flappy Bird did well. Other good
vertical games are Hoplite, Threes, You Must Build a Boat, 0h h1, and 0h n0.

##Build Games You Can Finish Building in a Short Period of Time
...
updating your games, but something "complete" should be released within two to three.
...
feedback. I've had people leave negative reviews, and then come back a few release later and
...
time to pitch your app for getting featured). There may come a time where you
...
Here are a few examples of a review that I got for A Dark Room that are eligible for
...
Geometry Dash, Crossy Road, Threes Free. Each one takes a tasteful approach to
ads. If you want a bit more revenue info with regards to ads,
[I've written about it here](http://amirrajan.net/a-dark-room/#alternateuniverse).

With regards to an IAP that removes ads, give the something additional. There is
novel a tower defense game called Bardbarin. It has is an IAP that removes ads,
...
five minutes in... don't do this. Find the perfect time present a review button
...
endless really well, take a look at Desert Golf and You Must Build a Boat. It's
important to realize that length does not equal value.
...
For your screenshots. Pair screenshots up with words. Few people actually read
...
Give them away like candy (especially since your releasing so often).
...
back and I'll send you codes." They wont email you back, and they won't
...
does a better job. Another game that (IMHO) does a better than the "original"
...
As an indie game developer, you can capitalize on "having heart". Take
a look at Space Team (you can "feel" the heart this game has, even though it
looks unpolished). You want to get to a point where people say "Oh, Amir
...
to be created with other genres.
...
put into your games worth it (even if your game fails financially). I can
only do game development part time (I doesn't pay all the bills). But damn
